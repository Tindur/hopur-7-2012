...
namespace GameSchool.Models.Interfaces
{
    interface ILevelRepository
    {
        ...
        List<LectureModel> GetLecturesForLevel(int levelID);
        List<CommentModel> GetAllCommentsForLecture(int lectureID);
        List<AssignmentModel> GetAllAssignmentForLevel(int levelID);
        #endregion
